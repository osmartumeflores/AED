...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (!salir) {
            ...
            System.out.println("6. Detectar nodos aislados");
    ...
    // Detecta nodos sin conexiones (aislados)
    private static void detectarNodosAislados() {
        System.out.println("\n--- Nodos aislados ---");
        List<Nodo> aislados = grafo.obtenerNodosAislados();
        if (aislados.isEmpty()) {
            System.out.println("No hay nodos aislados.");
        } else {
            for (Nodo n : aislados) {
